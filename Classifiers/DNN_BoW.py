...
embeddings_index = {}
words_not_found=[]
f=open ("crawl-300d-2M.vec", "r", encoding="utf-8")
for line in f:
    values = line.split()
    word = values[0]
...
CNN_History=model.fit(x_train, y_train, epochs = 10, batch_size = 256,verbose=1, validation_data=(x_val,y_val), shuffle=True)
