...
CNN_Model.add(layers.Conv1D(1024, 3, activation='relu'))
...
#CNN_Model.add(SeqSelfAttention(attention_width=4,
...
CNN_History=CNN_Model.fit(x_train, y_train, epochs = 15, batch_size = 256,verbose=1, validation_data=(x_val,y_val), shuffle=True)
