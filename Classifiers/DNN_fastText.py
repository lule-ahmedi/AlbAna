...
DNN_Model.add(layers.Embedding(len(word_index) + 1,
                            EMBEDDING_DIM,
...
DNN_History=DNN_Model.fit(x_train, y_train, epochs = 35, batch_size = 256,verbose=1, validation_data=(x_val,y_val), shuffle=True)
